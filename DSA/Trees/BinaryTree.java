...
class BinaryTree {
    ...
    public void populate(Scanner scanner){
        ...
        System.out.println("Enter value to add to tree: ");
    ...
    private void populate(Scanner scanner, Node node){
        ...
        if(left){
            System.out.println("Enter the valu eto enter:");
    ...
    public void displayGood(Node node,int level){
        if(node==null){
            return;
        }
        displayGood(node.right,level+1);
